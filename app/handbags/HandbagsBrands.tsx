...
const brandLogos = [
  {
    name: "Hermès",
    description: "French luxury brand renowned for exceptional leather craftsmanship",
    heritage: "180+ Years",
    specialty: "Birkin & Kelly Collections",
    foundedYear: "1837"
  },
  {
    name: "Louis Vuitton",
  ...
  {
    name: "Chanel",
    description: "Legendary Parisian brand defining luxury and sophistication",
    heritage: "115+ Years",
    specialty: "Quilted Bags",
    foundedYear: "1910"
  },
  {
    name: "Gucci",
    description: "Italian luxury brand blending heritage with contemporary design",
    heritage: "105+ Years",
    specialty: "GG Supreme Collection",
    foundedYear: "1921"
  },
  {
    name: "Prada",
    description: "Italian fashion house known for innovative luxury accessories",
    heritage: "115+ Years",
    specialty: "Nylon & Saffiano",
    foundedYear: "1913"
  },
  {
    name: "Bottega Veneta",
    description: "Italian luxury brand celebrated for exceptional leather goods",
    heritage: "60+ Years",
    specialty: "Intrecciato Weaving",
    foundedYear: "1966"
  }
];
    ...
    <section className="py-20 bg-gray-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-black text-black mb-4">FEATURED BRANDS</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover the world's most prestigious handbag brands, each representing decades of craftsmanship and luxury
          </p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group cursor-pointer">
                <div className="text-4xl font-black text-black mb-2 group-hover:scale-110 transition-transform duration-300">180+</div>
              ...
              <div className="group cursor-pointer">
                ...
                <div className="text-sm uppercase tracking-wider text-gray-500">Leather Quality</div>
              </div>
              <div className="group cursor-pointer">
                <div className="text-4xl font-black text-black mb-2 group-hover:scale-110 transition-transform duration-300">Exclusive</div>
                <div className="text-sm uppercase tracking-wider text-gray-500">Limited Collections</div>
              </div>
            </div>
          </div>
        </div>
